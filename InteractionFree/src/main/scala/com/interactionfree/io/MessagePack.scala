...
import com.interactionfree.core.{Message, MessageException}
import org.msgpack.value.Value

import scala.collection.mutable.{HashMap, HashSet, ListBuffer}

object MessagePack {
  protected[io] val ExtensionType: Byte = 11
  ...
  val encoding = "MSGPACK"

  def pack(value: Any): Array[Byte] = {
    new MessagePacker().feed(value).pack()
  }

  protected[io] def allocate(obj: Any, invoker: String) = {
