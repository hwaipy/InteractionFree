...
if __name__ == '__main__':
    ...
    cm = ClockManager(worker1.asyncInvoker('HMC7044EvalAlice'), worker1.asyncInvoker('HMC7044EvalBob'), worker1.asyncInvoker('HMC7044EvalCharlie'))
    worker2 = IFWorker('tcp://172.16.60.200:224', 'TF_ClockManager', cm, force=True)
    IFLoop.join()
