...
function Endpoint(address) {
  ...
  function open() {
    ...
    webSocket = new window.WebSocket(address);
...
function SocketBase(xattachEndpoint, xendpointTerminated, xhasOut, xsend,
  xonMessage) {
...
JSMQ.Dealer = function() {
  ...
  var that = new SocketBase(xattachEndpoint, xendpointTerminated, xhasOut,
    xsend, xonMessage);
